(function() {
    function initPlayer() {
        ...
        if (!video || !playButton || !progressBar) {
            // Les éléments ne sont pas encore disponibles dans le DOM, réessayer après un court délai
    ...
    // Exécuter initPlayer immédiatement si le DOM est déjà prêt, sinon attendre l'événement DOMContentLoaded
